...
function prismicStatic( apiKey ) {
    this._apiKey = apiKey;
};

var proto = prismicStatic.prototype;
...
*/
proto.getAllDocuments = function( callback ) {
    Prismic.Api( this._apiKey, function( err, api ) {
...
** @param {function}    callback    :  function to execute on completion
*/
proto.getDocumentsByType = function( type, callback ) {
    this.getAllDocuments( function( res ) {
...
*/
proto.getTaggedDocuments = function( type, callback ) {
    this.getAllDocuments( function( res ) {
        callback( res.tags[type] );
    });
};

module.exports = prismicStatic;
